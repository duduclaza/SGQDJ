...
// Carrega RouteServiceProvider se existir, senão usa rotas inline
$routesFile = __DIR__ . '/../routes/RouteServiceProvider.php';
if (file_exists($routesFile)) {
    // Sistema modular - carrega todas as rotas via RouteServiceProvider
    require_once $routesFile;
    RouteServiceProvider::register($router);
} else {
    // FALLBACK: Se RouteServiceProvider não existir, carrega rotas inline
    // (Mantém compatibilidade caso algo dê errado)
    die("ERRO: RouteServiceProvider não encontrado em: {$routesFile}");
}
