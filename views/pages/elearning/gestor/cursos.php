  ...
  <div class="el-gradient-header rounded-2xl p-6 sm:p-8 text-white shadow-lg">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      ...
      <div class="flex items-center gap-3">
        <?php if ($canDelete): ?>
        <a href="/elearning/gestor/diploma/config" title="Configurar Diplomas" class="w-10 h-10 flex items-center justify-center bg-white/20 hover:bg-white/30 backdrop-blur text-white rounded-xl transition border border-white/30 shadow-sm">
